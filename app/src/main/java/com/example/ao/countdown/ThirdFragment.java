...
public class ThirdFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //修改计时值
        TextView textView=(TextView)view.findViewById(R.id.ThirdView);
        ...
        Button btn=(Button)view.findViewById(R.id.mainbutton3);
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!flag){
                    startTimer();
                    Button btn=(Button)v.findViewById(R.id.mainbutton3);
                    btn.setText("Stop");
                    flag=true;
                }
                else{
        ...
        ImageButton music=(ImageButton) view.findViewById(R.id.music3);
...
//        tv.setText("这是主页面");
    ...
    public void startTimer() {
        TextView view=getView().findViewById(R.id.ThirdView);
        ...
        if (countDownTimer == null) {
            countDownTimer = new CountDownTimer(fullminute*60*1000, 1000){
                TextView minute=(TextView)getView().findViewById(R.id.ThirdView);
                TextView second=(TextView)getView().findViewById(R.id.ThirdView2);
...
//                .setMessage("是否删除")
                .setPositiveButton("15", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        TextView view=v.findViewById(R.id.ThirdView);
    ...
    public void start(){
        Intent intent = new Intent(getActivity(),AudioService3.class);
